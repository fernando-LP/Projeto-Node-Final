...
const Usuario = (props) => {
    ...
    return (
        <Page>
             <div style={{ flexDirection: "center", justifyContent: "center" }}>
                <h2><Link to="/"><BackButton /></Link>Lista de usuários</h2>
            </div>
            <a href="#cadastro"><Button bgcolor="blue">Novo usuário</Button></a>
             <div id="cadastro">
                <h2>Novo usuário</h2>
                <form>
                    <InputArea>
                    ...
                    <ButtonContainer>
                        ...
                        } bgcolor="#9AC0CD">Cadastrar</Button>
                    </ButtonContainer>
                </form>
            </div>
            <div id="atualizar">
            ...
            {users.map((user, index) => {
                return <UserArea key={index}>
                    ...
                    <FooterArea>
                        <Button bgcolor="#8B0000" onClick={() => handleDeleteUser(user.id_usuario)}>Excluir</Button>
