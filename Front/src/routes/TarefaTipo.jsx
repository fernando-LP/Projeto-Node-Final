...
const TipoTarefa = () => {
    ...
    return (
        <Page>
            ...
            <a href="#cadastro"><Button bgcolor="#8B4513" style={{ width: 120 }}>Novo tipo tarefa</Button></a>
            <div id="cadastro">
            ...
            {tiposTarefas.map((tt, index) => {
                return <UserArea key={index}>
                    ...
                    <FooterArea>
                        <Button bgcolor="#8B0000" onClick={() => handleDeleteTipoTarefa(tt.id)}>Excluir</Button>
