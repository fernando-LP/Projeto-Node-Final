...
const StatusTarefa = () => {
    ...
    return (
        <Page>
            ...
            <a href="#cadastro"><Button bgcolor="#8B4513" style={{ width: 130 }}>Novo status tarefa</Button></a>
            <div id="cadastro">
            ...
            {statusTarefas.map((st, index) => {
                return <UserArea key={index}>
                    ...
                    <FooterArea>
                        <Button bgcolor="#8B0000" onClick={() => handleDeleteStatusTarefa(st.id)}>Excluir</Button>
