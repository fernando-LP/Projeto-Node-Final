...
const Tarefa = () => {
    ...
    return (
        <Page>
            ...
            <a href="#cadastro"><Button bgcolor="#8B4513">Nova tarefa</Button></a>
            <div id="cadastro">
                ...
                <form>
                    ...
                    <InputArea>
                        ...
                        <TextInput type="text" placeholder="Se autorizada TRUE" onChange={e => SetAuthorized(e.target.value)} />
                    </InputArea>
                    <ButtonContainer>
            ...
            {tarefas.map((tarefa, index) => {
                return <UserArea key={index}>
                    ...
                    <FooterArea>
                        <Button bgcolor="#8B0000" onClick={() => handleDeleteTarefa(tarefa.id)}>Excluir</Button>
